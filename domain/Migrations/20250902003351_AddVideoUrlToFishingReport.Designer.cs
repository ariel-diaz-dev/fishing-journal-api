...
namespace domain.Migrations
{
    ...
    [Migration("20250902003351_AddVideoUrlToFishingReport")]
    partial class AddVideoUrlToFishingReport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Landing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("FishingReportId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int?>("LeaderLineTestInPounds")
                        .HasColumnType("int");
                    ...
                    b.Property<Guid?>("LureUsed")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int?>("MainLineTestInPounds")
                        .HasColumnType("int");

                    b.Property<Guid?>("ReelUsed")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("RodUsed")
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTime?>("TimeOfCatch")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("FishingReportId");

                    b.HasIndex("LengthInInches");
            ...
            modelBuilder.Entity("Domain.Models.Landing", b =>
                {
                    ...
                    b.HasOne("Domain.Models.FishSpecies", "FishSpecies")
                        .WithMany()
                        .HasForeignKey("FishSpeciesId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Models.FishingReport", "FishingReport")
                        .WithMany()
                        .HasForeignKey("FishingReportId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Domain.Models.Tackle", "Lure")
                        .WithMany()
                        .HasForeignKey("LureUsed")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Domain.Models.Tackle", "Reel")
                        .WithMany()
                        .HasForeignKey("ReelUsed")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Domain.Models.Tackle", "Rod")
                        .WithMany()
                        .HasForeignKey("RodUsed")
                        .OnDelete(DeleteBehavior.NoAction);
